/*
 * SVG Converter API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the SVG Converter API.
 * API Documentation: https://docs.apiverve.com/ref/svgconverter
 */
...
{
    class SVGConverterExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/svgconverter";

        /// <summary>
        /// Make a GET request to the SVG Converter API
        /// </summary>
        static async Task<JsonDocument> CallSVGConverterAPI()
        {
            try
            {
        ...
        {
            Console.WriteLine("📤 Calling SVG Converter API...\n");

            var result = await CallSVGConverterAPI();
