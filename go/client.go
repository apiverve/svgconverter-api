// Package svgconverter provides a Go client for the SVG Converter API.
//
// For more information, visit: https://apiverve.com/marketplace/svgconverter?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/svgconverter"
	defaultTimeout = 30 * time.Second
)

// Client is the SVG Converter API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new SVG Converter API client.
...
// ExecuteWithFile makes a request to the SVG Converter API with a file upload.
...
// Execute makes a request to the SVG Converter API with typed parameters.
//
...
//   - image (required): string - Upload an SVG file to convert
