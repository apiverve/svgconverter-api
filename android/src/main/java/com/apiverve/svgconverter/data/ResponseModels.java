...
//
//     SVGConverterData data = Converter.fromJsonString(jsonString);

package com.apiverve.svgconverter.data;
...
public class Converter {
    ...
    public static SVGConverterData fromJsonString(String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    public static String toJsonString(SVGConverterData obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.readerFor(SVGConverterData.class);
        writer = mapper.writerFor(SVGConverterData.class);
    }
