...
```gradle
dependencies {
    implementation 'com.github.apiverve:svgconverter-api:1.1.13'
}
```
...
```java
import com.apiverve.svgconverter.SVGConverterAPIClient;
import com.apiverve.svgconverter.APIResponse;
import com.apiverve.svgconverter.APIException;

// Initialize the client
SVGConverterAPIClient client = new SVGConverterAPIClient("YOUR_API_KEY");
...
This API requires a file upload. Supported file types: .svg (max 10MB)
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/svgconverter](https://docs.apiverve.com/ref/svgconverter)
...
- **Documentation:** [https://docs.apiverve.com/ref/svgconverter](https://docs.apiverve.com/ref/svgconverter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/svgconverter-api/issues)
